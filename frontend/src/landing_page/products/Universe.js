    ...
    <div className="container mt-3">
      <div className="row text-center text-muted " style={{fontSize:"12px"}}>
        ...
        <div className="col-4 p-3 mt-3">
          ...
          <p className="text-small text-muted p-4">Our asset management venture
            <br></br>
...
funds to help you save for your goals.
        ...
        <div className="col-4 p-3 mt-3">
          ...
          <p className="text-small text-muted p-4">Options trading platform that lets you  <br></br>
...
data points like open interest, FII/DII, and more.
        ...
        <div className="col-4 p-3 mt-3" >
          ...
          <p className="text-small text-muted p-4">Thematic investment platform  Extend
        ...
        <div className="col-4 p-3 mt-3">
          ...
          <p className="text-small text-muted p-4">Investment research platform
            <br></br>
...
sectors, supply chains, and more.</p>
        ...
        <div className="col-4 p-3 mt-3">
          ...
          <p className="text-small text-muted p-4">Systematic trading platform
that 
...
strategies without coding.
        ...
        <div className="col-4 p-3 mt-3">
          ...
          <p className="text-small text-muted p-4">Personalized advice on life
<br></br>
