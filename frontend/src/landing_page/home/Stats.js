...
function Stats() {
    return (  
            ...
            <div className='row p-5'>
                ...
                <div className='col-6 p-5'>
                    <img src='media/images/ecosystem.png' style={{width:"99%"}} className=''/>
                   <div className='text-center'>
                    ...
                    <a href='' className='mx-5 fs-5' style={{textDecoration:"none"}}>Try Kite -- <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                   </div>
                </div>
                <img src='media/images/press-logos.png' style={{width:"60%",margin:"auto"}}/>
            </div>
        </div>
    );
}
